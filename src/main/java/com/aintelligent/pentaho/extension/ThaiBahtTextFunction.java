...
public class ThaiBahtTextFunction implements Function {

  private static final long serialVersionUID = 4984027687466610131L;

  public ThaiBahtTextFunction() {
    // Constructor
  }
  ...
  public TypeValuePair evaluate(FormulaContext context, ParameterCallback parameters) throws EvaluationException {
    ...
    String thaitext = "";
    thaitext = new ThaiBahtText().getText(result);

    return new TypeValuePair(TextType.TYPE, thaitext);
  }
